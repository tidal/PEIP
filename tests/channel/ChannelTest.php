...
class ChannelTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $handler1 = new PEIP_Callable_Handler(['TestClass', 'TestMethod1']);
        $handler2 = new PEIP_Callable_Handler(['TestClass', 'TestMethod2']);
        $this->channel->connect('postSend', $handler1);
        $this->channel->connect('postSend', $handler2);
        $this->assertEquals([$handler1, $handler2], $this->channel->getListeners('postSend'));
    }
    ...
    public function testSetEventDispatcherTransferListners()
    {
        ...
        $this->assertEquals([$handler1, $handler2], $this->channel->getListeners('test'));
    }
}
