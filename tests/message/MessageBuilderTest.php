...
class MessageBuilderTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $headers = ['foo' => 'bar', 'do' => 'test'];
        $this->assertEquals([], $this->builder->getHeaders());
    ...
    public function testRemoveHeader()
    {
        ...
        $this->assertEquals(['do' => 'test'], $this->builder->getHeaders());
    }
