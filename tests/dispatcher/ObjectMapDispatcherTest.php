...
class ObjectMapDispatcherTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetEventNames()
    {
        $object = new stdClass();
        $handler = new PEIP_Callable_Handler('TestClass', 'TestMethod');
        $this->assertEquals([], $this->dispatcher->getEventNames($object));
        $events = ['foo', 'bar', 'test'];
    ...
    public function testGetListeners()
    {
        ...
        $this->assertEquals([], $this->dispatcher->getListeners('foo', $object));
        $listeners = [
